...
output_dir="./lncRNA_known/netMHCpan/HLA_1/netMHCpan_1_result"
...
run_netmhcpan() {
    ...
    local output_file="${output_dir}/${task_file_name}.txt"
    ...
    if "$netmhcpan" \
        ...
        rm -f "$running_flag"
        echo "[ERROR] ${task_index} | ${task_file_name}" >&2
        return 1
